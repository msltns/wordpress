        ...
        public function __construct() {
            ...
            $this->scripts = [
                'msltnscss' => [
                    ...
                    'type'   => 'style',
                    'handle' => 'msltns',
                    'src'    => trailingslashit( network_home_url() ) . 'msltnscss/frontend',
                ],
                'bootstrapcss' => [
                    'action' => 'register',
                    'type'   => 'style',
                    'handle' => 'bootstrap',
                    'src'    => trailingslashit( network_home_url() ) . 'msltnscss/bootstrap',
                ],
                'bootstrapjs' => [
                    'action' => 'register',
                    'type'   => 'script',
                    'handle' => 'bootstrap',
                    'src'    => trailingslashit( network_home_url() ) . 'msltnsjs/bootstrap',
                    'deps'   => [ 'jquery' ],
                    'footer' => true,
                ],
            ];
